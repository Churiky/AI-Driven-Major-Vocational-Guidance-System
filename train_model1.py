...
REPORT_DIR = Path("reports") / "train_model1"
CHECKPOINT_PATH = MODEL_DIR / "transformer_synthetic_best.pth"
SCALER_PATH = MODEL_DIR / "transformer_synthetic_scaler.pkl"
CLASSES_PATH = MODEL_DIR / "transformer_synthetic_classes.pkl"
...
class Trainer:
    ...
    def train(
        ...
        print(f"Bat dau huan luyen Transformer sach voi toi da {epochs} epochs...")
