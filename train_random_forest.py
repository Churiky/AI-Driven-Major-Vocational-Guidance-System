...
REPORT_DIR = Path("reports") / "reportRandom"

# Outputs
CHECKPOINT_PATH = MODEL_DIR / "rf_synthetic_best.pkl"
...
def plot_test_metrics(test_metrics, output_path):
    ...
    ax.set_ylim(0, 1.05)
    ax.set_title("Random Forest Test Metrics")
    ax.set_ylabel("Score")
...
def main():
    ...
    print("\n" + "=" * 60)
    print("TÓM TẮT KẾT QUẢ TEST - RANDOM FOREST")
